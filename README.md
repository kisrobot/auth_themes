...
Auth Themes is a collection of themes for [Auth](https://github.com/kisrobot/auth), which is a Golang authentication framework.

It aimis to reduce repeated code, make you be able to integrate [Auth](https://github.com/kisrobot/auth) into your application with few lines of code.
...
```go
import  "github.com/kisrobot/auth_themes/clean"
...
Refer Theme [Clean](https://github.com/kisrobot/auth_themes/tree/master/clean) for more details
